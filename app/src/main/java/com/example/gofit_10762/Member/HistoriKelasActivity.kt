...
import com.example.gofit_10762.databinding.ActivityHistoriKelasBinding

class HistoriKelasActivity : AppCompatActivity() {
    private lateinit var binding : ActivityHistoriKelasBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityHistoriKelasBinding.inflate(layoutInflater)
    ...
    fun showDataFragment(idUser: String, nama: String) {
        ...
        val mFragment = DataHistoriKelasFragment()
        val mBundle = Bundle()
