...
import com.example.gofit_10762.databinding.FragmentBookingKelasBinding
...
class BookingKelasFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnBooking.setOnClickListener {
            val intent = Intent(requireActivity(), BookingKelasActivity::class.java)
        ...
        binding.btnLihat.setOnClickListener{
            val intent = Intent(requireActivity(), DataBookingKelasActivity::class.java)
            intent.putExtra("idUser", idUser)
            intent.putExtra("nama", nama)
            intent.putExtra("jabatan", jabatan)
            intent.putExtra("username", username)
